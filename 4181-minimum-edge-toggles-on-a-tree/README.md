<h2><a href="https://leetcode.com/problems/minimum-edge-toggles-on-a-tree">4181. Minimum Edge Toggles on a Tree</a></h2><h3>Hard</h3><hr><p>You are given an <strong>undirected tree</strong> with <code>n</code> nodes, numbered from 0 to <code>n - 1</code>. It is represented by a 2D integer array <code>edges</code>âââââââ of length <code>n - 1</code>, where <code>edges[i] = [a<sub>i</sub>, b<sub>i</sub>]</code> indicates that there is an edge between nodes <code>a<sub>i</sub></code> and <code>b<sub>i</sub></code> in the tree.</p>
...
<p>Return an array of edge indices whose operations transform <code>start</code> into <code>target</code>. Among all valid sequences with <strong>minimum possible length</strong>, return the edge indices in <strong>increasing</strong>âââââââ order.</p>
...
<p><strong class="example"><img alt="" src="https://assets.leetcode.com/uploads/2025/12/18/example1.png" style="width: 271px; height: 51px;" />âââââââ</strong></p>
...
âââââââThe string changes from <code>&quot;010&quot;</code> to <code>&quot;100&quot;</code>, matching the target.</p>
</div>
...
<p><strong class="example"><img alt="" src="https://assets.leetcode.com/uploads/2025/12/18/example3.png" style="width: 161px; height: 51px;" />âââââââ</strong></p>
